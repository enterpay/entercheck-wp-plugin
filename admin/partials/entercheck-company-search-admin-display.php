...
<form action="options.php" method="post">
	...
	echo '<p>'.esc_attr('You can view all form submissions in the dashboard, by navigating to ').'<a href="https://entercheck.eu/dashboard/forms/submissions" target="_blank">https://entercheck.eu/dashboard/forms/submissions</a></p>';
	 ?>
